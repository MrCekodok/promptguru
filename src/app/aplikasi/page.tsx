...
export const metadata = {
  title: "Aplikasi contoh — PromptBina",
};
    ...
    <div className="flex min-h-full flex-1 flex-col bg-[#f4f7fb]">
      <header className="sticky top-0 z-20 border-b border-[#d7e0ee] bg-white">
        ...
        <div className="mx-auto flex w-full max-w-5xl items-center justify-between gap-3 px-4 py-3.5 sm:px-6">
          <div>
            <p className="text-sm font-semibold tracking-tight">Aplikasi contoh</p>
            <p className="text-[0.7rem] tracking-wide text-muted-foreground uppercase">
              Tiga aplikasi sekolah yang boleh dicuba
            </p>
          </div>
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-8 sm:px-6 sm:py-10">
        <h1 className="max-w-2xl text-3xl font-semibold tracking-tight sm:text-4xl">
          Cuba aplikasi, bukan sekadar baca prompt.
        </h1>
        <p className="mt-3 max-w-2xl text-base leading-relaxed text-muted-foreground">
          Tiga aplikasi ini dibina daripada contoh PromptBina. Data disimpan
          pada pelayar anda. Buka satu, klik menu, dan selesaikan kerja sebenar.
        </p>
